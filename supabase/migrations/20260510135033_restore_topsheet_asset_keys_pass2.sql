-- Restore topsheet_asset_key for 3 of 4 previously-nulled (Voile
-- HyperVector BC stays null — its raw is still a multi-ski catalog
-- photo the de-pair pipeline can't isolate) plus 30 newly-added
-- variants whose raws were just sourced + processed.
