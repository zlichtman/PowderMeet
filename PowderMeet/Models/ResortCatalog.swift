...
nonisolated struct ResortEntry: Identifiable, Hashable {
    ...
    var searchableText: String {
        ([id.replacingOccurrences(of: "-", with: " "), name, region, Self.regionLabel(region), country, country == "USA" ? "United States America" : "", passLabel] + aliases).joined(separator: " ").lowercased()
    }
...
nonisolated extension ResortEntry {
    ...
    private static let epicResorts: [ResortEntry] = [
        ...
        ResortEntry(id: "wildcat", name: "Wildcat Mountain", bounds: box(44.257441, -71.233362, latSpan: 0.0401, lonSpan: 0.0501), region: "NH", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "crotched", name: "Crotched Mountain", bounds: box(43.008789, -71.878761, latSpan: 0.0401, lonSpan: 0.0501), region: "NH", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "mount-sunapee", name: "Mount Sunapee", bounds: box(43.325768, -72.074541, latSpan: 0.0500, lonSpan: 0.0501), region: "NH", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "laurel-mountain", name: "Laurel Mountain", bounds: box(40.166786, -79.169332, latSpan: 0.0401, lonSpan: 0.0501), region: "PA", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "jack-frost", name: "Jack Frost", bounds: box(41.110600, -75.652019, latSpan: 0.0401, lonSpan: 0.0400), region: "PA", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "big-boulder", name: "Big Boulder", bounds: box(41.048564, -75.601302, latSpan: 0.0401, lonSpan: 0.0400), region: "PA", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "alpine-valley-ohio", name: "Alpine Valley", bounds: box(41.528367, -81.261269, latSpan: 0.0401, lonSpan: 0.0501), region: "OH", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "hidden-valley-mo", name: "Hidden Valley (Missouri)", bounds: box(38.536139, -90.654349, latSpan: 0.0301, lonSpan: 0.0400), region: "MO", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "snow-creek", name: "Snow Creek", bounds: box(39.465422, -94.969032, latSpan: 0.0401, lonSpan: 0.0501), region: "MO", country: "USA", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "nakiska", name: "Nakiska", bounds: box(50.948417, -115.169991, latSpan: 0.0500, lonSpan: 0.0601), region: "AB", country: "Canada", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        // ── Japan (Epic) ──
        ResortEntry(id: "hakuba-goryu", name: "Hakuba Goryu", bounds: box(36.664514, 137.825219, latSpan: 0.0401, lonSpan: 0.0501), region: "JP", country: "Japan", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "hakuba-norikura", name: "Hakuba Norikura Onsen", bounds: box(36.769527, 137.870402, latSpan: 0.0301, lonSpan: 0.0401), region: "JP", country: "Japan", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "hakuba-sanosaka", name: "Hakuba Sanosaka Snow Resort", bounds: box(36.622995, 137.836522, latSpan: 0.0301, lonSpan: 0.0401), region: "JP", country: "Japan", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "hakuba47", name: "Hakuba47 Winter Sports Park", bounds: box(36.672183, 137.821662, latSpan: 0.0401, lonSpan: 0.0501), region: "JP", country: "Japan", passProducts: [.epic], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "jiigatake", name: "Jiigatake", bounds: box(36.560404, 137.798302, latSpan: 0.0301, lonSpan: 0.0401), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["Jigatake Snow Resort"], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "kashimayari", name: "Kashimayari", bounds: box(36.600855, 137.829214, latSpan: 0.0301, lonSpan: 0.0401), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["Kashimayari Snow Resort"], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "tsugaike", name: "Tsugaike Kogen", bounds: box(36.755229, 137.850739, latSpan: 0.0401, lonSpan: 0.0494), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["Tsugaike Mountain Resort"], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "rusutsu", name: "Rusutsu", bounds: box(42.731103, 140.915201, latSpan: 0.0644, lonSpan: 0.0700), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["Rusutsu Resort"], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "furano", name: "Furano", bounds: box(43.332667, 142.339369, latSpan: 0.0500, lonSpan: 0.0601), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["Furano Ski Resort"], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "myoko-suginohara", name: "Myoko Suginohara", bounds: box(36.863463, 138.137148, latSpan: 0.0401, lonSpan: 0.0564), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["Myoko Suginohara Ski Resort"], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "nekoma", name: "Nekoma Mountain", bounds: box(37.605112, 140.037090, latSpan: 0.0569, lonSpan: 0.0501), region: "JP", country: "Japan", passProducts: [.epic], aliases: ["NEKOMA"], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "hintertuxer", name: "Hintertuxer Gletscher", bounds: box(47.087175, 11.667267, latSpan: 0.0857, lonSpan: 0.0701), region: "AT", country: "Austria", passProducts: [.epic], aliases: ["Hintertux Glacier"], pinnedSnapshotDate: "2026-09-20"),
    ...
    private static let ikonResorts: [ResortEntry] = [
        ...
        // ── USA — Idaho ──
        ResortEntry(id: "sun-valley", name: "Sun Valley", bounds: box(43.664720, -114.374807, latSpan: 0.0598, lonSpan: 0.0895), region: "ID", country: "USA", passProducts: [.ikon], aliases: ["Bald Mountain", "Dollar Mountain"], pinnedSnapshotDate: "2026-09-20"),
        ...
        // ── USA — Massachusetts ──
        ResortEntry(id: "jiminy-peak", name: "Jiminy Peak", bounds: box(42.548815, -73.285832, latSpan: 0.0401, lonSpan: 0.0501), region: "MA", country: "USA", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "the-highlands", name: "The Highlands", bounds: box(45.477145, -84.939874, latSpan: 0.0500, lonSpan: 0.0601), region: "MI", country: "USA", passProducts: [.ikon], aliases: ["Boyne Highlands"], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "wild-mountain", name: "Wild Mountain", bounds: box(45.488357, -92.708401, latSpan: 0.0301, lonSpan: 0.0400), region: "MN", country: "USA", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        // ── Canada — Quebec ──
        ResortEntry(id: "tremblant", name: "Tremblant", bounds: box(46.224964, -74.556244, latSpan: 0.0624, lonSpan: 0.0807), region: "QC", country: "Canada", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "le-massif", name: "Le Massif de Charlevoix", bounds: box(47.279611, -70.596598, latSpan: 0.0601, lonSpan: 0.0601), region: "QC", country: "Canada", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "lotte-arai", name: "Lotte Arai Resort", bounds: box(36.989481, 138.157045, latSpan: 0.0401, lonSpan: 0.0579), region: "JP", country: "Japan", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ResortEntry(id: "appi", name: "APPI Resort", bounds: box(39.987201, 140.967336, latSpan: 0.0500, lonSpan: 0.0628), region: "JP", country: "Japan", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "mt-t", name: "Mt. T", bounds: box(36.825437, 138.953690, latSpan: 0.0401, lonSpan: 0.0501), region: "JP", country: "Japan", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        // ── New Zealand (Ikon) ──
        ResortEntry(id: "coronet-peak", name: "Coronet Peak", bounds: box(-44.922286, 168.738201, latSpan: 0.0500, lonSpan: 0.0601), region: "NZ", country: "New Zealand", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        // ── South Korea (Ikon) ──
        ResortEntry(id: "yunding", name: "Yunding Snow Park", bounds: box(40.947941, 115.419071, latSpan: 0.0401, lonSpan: 0.0501), region: "CN", country: "China", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
        ...
        ResortEntry(id: "pila", name: "Pila", bounds: box(45.692771, 7.307265, latSpan: 0.0401, lonSpan: 0.0501), region: "IT", country: "Italy", passProducts: [.ikon], pinnedSnapshotDate: "2026-09-20"),
    ...
    static func search(_ query: String, pass: PassProduct? = nil) -> [ResortEntry] {
        let terms = query.folding(options: [.diacriticInsensitive, .caseInsensitive], locale: Locale(identifier: "en_US_POSIX"))
            .split(whereSeparator: \.isWhitespace).map(String.init)
        return catalog.filter { entry in
            let passMatch = pass.map { entry.passProducts.contains($0) } ?? true
            let searchable = entry.searchableText.folding(options: [.diacriticInsensitive, .caseInsensitive], locale: Locale(identifier: "en_US_POSIX"))
            let textMatch = terms.allSatisfy { searchable.contains($0) }
