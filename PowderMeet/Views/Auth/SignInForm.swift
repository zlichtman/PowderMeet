    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                TextField("", text: $email, prompt: Text("YOUR@EMAIL.COM").foregroundColor(HUDTheme.textTertiary))
                    .hudType(.bodyEmph)
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                HStack(spacing: 0) {
                    ...
                    HUDSecureField(
                        text: $password,
                        // A bullet placeholder looks like a saved credential
                        // before the user has entered anything. Keep the empty
                        // state explicit; actual secure input still uses the
                        // accent-colored UIKit bullet rendering below.
                        placeholder: "ENTER PASSWORD",
                        textColor: HUDTheme.accent,
                        placeholderColor: HUDTheme.textTertiary,
