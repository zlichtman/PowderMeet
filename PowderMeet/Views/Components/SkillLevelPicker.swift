...
struct SkillTier: Hashable, Identifiable {
    ...
    static let allTiers: [SkillTier] = [
        ...
        SkillTier(key: "intermediate", label: "INTERMEDIATE", desc: "COMFORTABLE ON MARKED GREEN AND BLUE RUNS", level: 2),
        SkillTier(key: "advanced",     label: "ADVANCED",     desc: "BLACK RUNS AND MARKED TERRAIN PARKS",       level: 3),
        SkillTier(key: "expert",       label: "EXPERT",       desc: "ALL MARKED TERRAIN, INCLUDING DOUBLE BLACK", level: 4),
    ]
