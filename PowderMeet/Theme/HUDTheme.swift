...
enum HUDTheme {
    ...
    static var mapBackground: Color    { ThemeManager.shared.backgroundColor }
    static var cardBackground: Color   { ThemeManager.shared.cardBackground }
    static var cardBorder: Color       { ThemeManager.shared.cardBorder }
    static var inputBackground: Color  { ThemeManager.shared.inputBackground }
    static var headerBackground: Color { ThemeManager.shared.headerBackground.opacity(0.96) }
